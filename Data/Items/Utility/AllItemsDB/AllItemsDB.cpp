...
AllItemsDB::AllItemsDB() : m_allItemsDB { 
    ...
    new Helm(5, "Заячьи ушки", 2, 0.3, 50, 120,
        ...
        \nОднако привлекаешь всех извращенцев в округе, которые скоро тебе обьяснят что к чему."), 
    ...
    new Helm(7, "Академическая шапочка", 30, 0.2, 70, 228,
        ...
        \nЖаль что этих характеристик в игре нету, п.э. из полезного только внушающий ужас вид безумного человека окончившего универ."),
